...
while True:
    ...
    for cnt in contours:
        ...
        if area>1000 and area<15000:#Birden fazla dikdörtgen bulma durumunda burayı arttır. Alan Büyüdükçe dikdörtgen azalıcak.
            #CommunicateMotor.hedef:Tespit(True)
